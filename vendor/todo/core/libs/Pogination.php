...
class Pogination
{
    ...
    public function getHtml()
    {
        ...
        if ($this->currentPage > 3) {
            $srartpage = "<li class='page-item waves-effect'><a class='page-link pink darken-4 ' style='color: white' href='" . $this->uri . 'page=' . 1 . "'>
            First</a> </li></a> </li>";
        }

        if ($this->currentPage <= ($this->countPages - 3)) {
            $endpage = "<li class='page-item waves-effect'><a class='page-link pink darken-4' style='color: white' href='" . $this->uri . 'page=' . $this->countPages . "'>
            Last</a> </li>";
        }
...
<a   class='page-link' href='" . $this->uri . 'page=' . ($this->currentPage + 2) . "'>" . ($this->currentPage + 2) . "</a> </li>";
        ...
        <li class='page-item active pink darken-4'><a class='page-link' href='" . $this->uri . 'page=' . $this->currentPage . "'>" . $this->currentPage . "</a></li>
